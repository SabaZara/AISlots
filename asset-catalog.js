...
export const SYMBOL_SETS = Object.freeze([
  ...
  Object.freeze({ id: "abyssal", name: "Abyssal Treasures", collector: "Kraken Scatter", asset: "./assets/factory/symbols-abyssal-transparent-v3.png", scatterAsset: "./assets/factory/scatter-abyssal-v1.png", names: symbolNames(["Pearl Coin", "Coral Feather", "Jelly Star", "Tide Trident", "Wave Orb", "Shell Temple", "Kraken Scatter"]) })
]);
